        ...
        <>
            ...
            {status === "error" && (
                <>
                    ...
                    <Link
                        href="/portal/login"
                        className="inline-flex items-center justify-center px-6 py-3 bg-[#202e46] hover:bg-[#529ec6]/50 text-white font-medium rounded-xl transition-colors"
                    >
                        Request a new link
                    </Link>
                </>
...
export default function PortalVerifyPage() {
    return (
        <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-slate-900 via-[#202e46] to-slate-900 px-4">
            <div className="w-full max-w-md">
                {/* Logo */}
                <div className="flex items-center justify-center gap-3 mb-8">
                    <div className="w-12 h-12 bg-[#202e46] rounded-xl flex items-center justify-center">
