          ...
          <div className="space-y-6">
            ...
            {contracts.length === 0 ? (
              <div className="bg-white rounded-xl border border-slate-200 p-8 text-center">
                ...
                <Link
                  href="/contracts/new"
                  className="inline-flex items-center gap-2 px-4 py-2 bg-[#202e46] text-white rounded-lg hover:bg-[#1a2539]"
                >
                      ...
                      <button
                        ...
                        className={`p-2 rounded-lg text-left text-sm ${
                          isAdded
                            ...
                            : "bg-slate-50 hover:bg-[#529ec6]/5 text-slate-700"
                        }`}
                      >
            ...
            <div className="bg-white rounded-xl border border-slate-200 p-6">
              ...
              <div className="grid sm:grid-cols-4 gap-3">
                <input
                  ...
                  className="px-3 py-2 border border-slate-200 rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-[#529ec6]"
                />
                <input
                  type="email"
                  placeholder="Email"
                ...
                <button
                  ...
                  className="flex items-center justify-center gap-2 px-4 py-2 bg-[#202e46] text-white rounded-lg hover:bg-[#1a2539] disabled:bg-slate-200 disabled:text-slate-400 text-sm"
                >
                  <Plus className="w-4 h-4" />
                  Add
                </button>
          ...
          <div className="space-y-6">
                  ...
                  <div className="space-y-4">
                    ...
                    <div>
                      ...
                      <textarea
                        ...
                        rows={4}
                        className="w-full px-4 py-2 border border-slate-200 rounded-lg focus:outline-none focus:ring-2 focus:ring-[#529ec6] resize-none"
                      />
                    </div>
                  </div>
                </div>
                ...
                <div className="bg-white rounded-xl border border-slate-200 p-6">
                  ...
                  <div className="flex flex-wrap gap-2">
                    {recipients.slice(0, 10).map((recipient) => (
                      <span
                        key={recipient.id}
                        className="px-3 py-1 bg-[#529ec6]/10 text-[#202e46] rounded-full text-sm"
                      >
                        {recipient.name}
                      </span>
                    ))}
            ...
            {sendStatus === "sending" && (
              <div className="bg-white rounded-xl border border-slate-200 p-12 text-center">
                <Loader2 className="w-12 h-12 text-[#529ec6] animate-spin mx-auto mb-4" />
            ...
            {sendStatus === "complete" && (
              <div className="bg-white rounded-xl border border-emerald-200 p-12 text-center">
                ...
                <div className="flex items-center justify-center gap-4">
                  <Link
                    href="/dashboard"
                    className="px-6 py-3 bg-[#202e46] text-white rounded-lg hover:bg-[#1a2539]"
                  >
                    Back to Dashboard
                  </Link>
                  <Link
          ...
          <div className="flex justify-between mt-8 pt-6 border-t border-slate-200">
            ...
            {step < 3 ? (
              ...
              <button
                ...
                className="flex items-center gap-2 px-8 py-3 rounded-lg font-medium bg-gradient-to-r from-[#202e46] to-[#2a3d5c] text-white hover:from-[#1a2539] hover:to-[#202e46]"
              >
