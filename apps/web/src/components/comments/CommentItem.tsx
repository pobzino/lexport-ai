      ...
      <div className="flex gap-3">
        ...
        <div className="flex-shrink-0">
          {comment.user.image ? (
            ...
            <div className="w-8 h-8 rounded-full bg-[#529ec6]/10 text-[#202e46] flex items-center justify-center text-xs font-medium">
          ...
          {isEditing ? (
            <div className="space-y-2">
              <textarea
                ...
                className="w-full px-3 py-2 text-sm border border-slate-200 rounded-lg focus:ring-2 focus:ring-[#529ec6] focus:border-transparent resize-none"
                rows={3}
                autoFocus
              />
              <div className="flex items-center gap-2">
                <button
                  ...
                  className="flex items-center gap-1 px-3 py-1 text-xs bg-[#202e46] text-white rounded-lg hover:bg-[#1a2539] disabled:opacity-50"
                >
                  {isSaving ? (
            ...
            <div className="flex items-center gap-2 mt-2 opacity-0 group-hover:opacity-100 transition-opacity">
              {!isReply && onReply && (
                <button
                  ...
                  className="flex items-center gap-1 text-xs text-slate-500 hover:text-[#529ec6]"
                >
