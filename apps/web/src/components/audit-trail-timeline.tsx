...
const EVENT_COLORS: Record<string, { bg: string; text: string; border: string }> = {
  ...
  contract_sent: { bg: "bg-[#529ec6]/10", text: "text-[#529ec6]", border: "border-[#529ec6]/20" },
  ...
  signature_requested: { bg: "bg-[#529ec6]/10", text: "text-[#529ec6]", border: "border-[#529ec6]/20" },
  ...
  invoice_sent: { bg: "bg-[#529ec6]/10", text: "text-[#529ec6]", border: "border-[#529ec6]/20" },
  ...
  link_shared: { bg: "bg-[#529ec6]/10", text: "text-[#529ec6]", border: "border-[#529ec6]/20" },
      ...
      <div className="flex items-center justify-between gap-4 pb-4 border-b border-slate-200">
        <div className="flex items-center gap-2">
          ...
          <select
            ...
            className="text-sm border border-slate-200 rounded-lg px-3 py-1.5 focus:outline-none focus:ring-2 focus:ring-[#529ec6]"
          >
