...
const TEMPLATE_CONFIG: Record<InvoiceTemplateType, {
  ...
  milestone: {
    ...
    color: "text-[#529ec6]",
    iconBg: "bg-[#529ec6]/5",
    selectedBg: "bg-[#529ec6]/5",
    selectedBorder: "ring-[#529ec6]",
  },
  retainer: {
    icon: RefreshCw,
  ...
  return (
    <button
      ...
      className={`
        ...
        flex items-start gap-4
        ${isSelected
          ? "ring-2 ring-[#529ec6] border-transparent bg-[#529ec6]/5"
          : "border-slate-200 hover:border-slate-300 hover:shadow-sm"
        }
      `}
    >
      ...
      {/* Icon */}
      <div className={`w-11 h-11 rounded-xl ${isSelected ? "bg-[#529ec6]/10" : "bg-slate-100"} flex items-center justify-center flex-shrink-0`}>
        <FileText className={`w-5 h-5 ${isSelected ? "text-[#529ec6]" : "text-slate-500"}`} />
      </div>
