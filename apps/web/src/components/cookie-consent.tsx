                ...
                {showCustomize ? (
                    ...
                    <div className="p-6">
                        ...
                        <div className="space-y-4">
                            ...
                            <div className="flex items-center justify-between p-4 bg-slate-50 rounded-lg">
                                ...
                                <button
                                    ...
                                    className={`relative w-12 h-6 rounded-full transition-colors ${preferences.functional ? "bg-[#202e46]" : "bg-slate-300"}`}
                                >
                            ...
                            <div className="flex items-center justify-between p-4 bg-slate-50 rounded-lg">
                                ...
                                <button
                                    ...
                                    className={`relative w-12 h-6 rounded-full transition-colors ${preferences.analytics ? "bg-[#202e46]" : "bg-slate-300"}`}
                                >
                        ...
                        <div className="flex items-center gap-3 mt-6">
                            <button
                                onClick={saveCustom}
                                className="flex-1 px-4 py-2.5 bg-[#202e46] text-white font-medium rounded-lg hover:bg-[#1a2539] transition-colors"
                            >
                                Save Preferences
                            </button>
                        </div>
                    ...
                    <div className="p-6">
                        <div className="flex items-start gap-4">
                            <div className="w-10 h-10 bg-[#529ec6]/10 rounded-lg flex items-center justify-center flex-shrink-0">
                                <Cookie className="w-5 h-5 text-[#529ec6]" />
                            </div>
                            <div className="flex-1">
                                ...
                                <p className="text-slate-600 text-sm">
                                    ...
                                    Read our{" "}
                                    <Link href="/privacy" className="text-[#529ec6] hover:underline">
                                        Privacy Policy
                                    </Link>{" "}
                        ...
                        <div className="flex flex-col sm:flex-row items-stretch sm:items-center gap-3 mt-6">
                            ...
                            <button
                                onClick={acceptAll}
                                className="px-6 py-2.5 bg-[#202e46] text-white font-medium rounded-lg hover:bg-[#1a2539] transition-colors shadow-sm"
                            >
                                Accept All
                            </button>
                        </div>
