      ...
      <div className={`flex flex-col sm:flex-row gap-3 ${compact ? "" : "mb-6"}`}>
        ...
        <div className="relative flex-1">
          ...
          <input
            ...
            className="w-full pl-10 pr-4 py-2 border border-slate-200 rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-[#529ec6]/20 focus:border-[#529ec6]"
          />
        </div>
        ...
        <div className="flex gap-2">
          <select
            ...
            className="px-3 py-2 border border-slate-200 rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-[#529ec6]/20 focus:border-[#529ec6]"
          >
