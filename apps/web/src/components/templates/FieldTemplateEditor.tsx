  ...
  return (
    <div className="flex items-center gap-2">
      ...
      <button
        ...
        className="flex items-center gap-2 px-3 py-2 text-sm font-medium text-[#529ec6] bg-[#529ec6]/5 border border-[#529ec6]/20 rounded-lg hover:bg-[#529ec6]/10 transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
      >
