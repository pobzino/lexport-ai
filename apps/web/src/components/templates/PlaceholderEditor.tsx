    ...
    <div className="space-y-6">
      ...
      <div className="bg-slate-50 rounded-lg p-4">
        <div className="flex items-center justify-between mb-2">
          ...
          {showAutofill && userProfile && (
            <button
              ...
              className="flex items-center gap-2 px-3 py-1.5 text-sm font-medium text-[#529ec6] bg-[#529ec6]/5 rounded-lg hover:bg-[#529ec6]/10 transition-colors"
            >
        ...
        <div className="w-full bg-slate-200 rounded-full h-2">
          <div
            className="bg-[#202e46] h-2 rounded-full transition-all"
                ...
                <div key={placeholder.token} className="space-y-1">
                  ...
                  {placeholder.type === "textarea" ? (
                    <textarea
                      ...
                      rows={3}
                      className="w-full px-3 py-2 border border-slate-200 rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-[#529ec6]/20 focus:border-[#529ec6] resize-none"
                    />
                    ...
                    <input
                      ...
                      className="w-full px-3 py-2 border border-slate-200 rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-[#529ec6]/20 focus:border-[#529ec6]"
                    />
                    ...
                    <div className="relative">
                      ...
                      <input
                        ...
                        placeholder="0.00"
                        className="w-full pl-7 pr-3 py-2 border border-slate-200 rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-[#529ec6]/20 focus:border-[#529ec6]"
                      />
                    </div>
