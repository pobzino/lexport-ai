        ...
        {loading ? (
          ...
          <>
                      ...
                      <div className="flex items-center gap-2">
                        ...
                        {payment.hasInvoice ? (
                          ...
                          <button
                            ...
                            disabled={creating}
                            className="text-xs text-[#529ec6] hover:text-[#202e46] font-medium"
                          >
                            {creating ? "..." : "+ Invoice"}
                          </button>
                        )}
            ...
            <button
              ...
              disabled={creating}
              className="w-full flex items-center justify-center gap-2 px-4 py-3 bg-[#202e46] text-white rounded-lg hover:bg-[#1a2539] disabled:opacity-50 transition-colors"
            >
              {creating ? (
                <Loader2 className="w-4 h-4 animate-spin" />
              ) : (
