  ...
  return (
    <SafeAreaView className="flex-1 bg-slate-50" edges={["top"]}>
      ...
      <View className="border-b border-slate-200 bg-white px-6 py-4">
        <Text className="text-2xl font-bold text-slate-900">Signatures</Text>
        <Text className="text-slate-500">Track signature requests</Text>
      </View>

      {/* Stats */}
      <View className="flex-row gap-3 px-6 py-3 bg-white border-b border-slate-100">
        <View className="flex-1 rounded-xl bg-amber-50 p-3">
          <Text className="text-xl font-bold text-amber-600">{stats.pending}</Text>
          <Text className="text-xs text-amber-700">Pending</Text>
        </View>
        <View className="flex-1 rounded-xl bg-emerald-50 p-3">
          <Text className="text-xl font-bold text-emerald-600">{stats.signed}</Text>
          <Text className="text-xs text-emerald-700">Signed</Text>
        </View>
        <View className="flex-1 rounded-xl bg-red-50 p-3">
          <Text className="text-xl font-bold text-red-600">{stats.declined}</Text>
                  ...
                  <CardContent>
                    <View className="flex-row items-start gap-4">
                      ...
                      <View className="flex-1">
                        ...
                        <Text className="mt-2 text-sm text-slate-400" numberOfLines={1}>
