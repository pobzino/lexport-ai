-- ============================================================
-- Fix submit_signature function
-- Canonical version with proper signature_type enum cast.
-- Supersedes versions in 2024122801_fix_signature_type_cast.sql
-- and 20241228_document_integrity.sql.
-- ============================================================
...
DECLARE
  ...
  v_image_hash TEXT;
BEGIN
  -- Find the signature request with contract data
  SELECT sr.*, c.id AS c_id, c.content_hash AS stored_hash
