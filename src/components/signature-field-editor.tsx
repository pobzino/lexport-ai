          ...
          return (
            <div
              ...
              className={`rounded-xl border-2 transition-all duration-200 ${hasAnyField
                ? "border-violet-200 bg-gradient-to-br from-violet-50/50 to-white shadow-sm"
                  ...
                  {fieldConfigs.map((config) => {
                    ...
                    return (
                      ...
                      >
                        ...
                        <div className={`p-2 rounded-lg transition-colors ${isEnabled ? "bg-violet-200/50" : "bg-slate-200/50 group-hover:bg-slate-200"
                          }`}>
                          <Icon className="w-5 h-5" />
                        </div>
                        <div className="text-center">
                          <p className="text-sm font-medium">{config.label}</p>
                          <p className={`text-[10px] ${isEnabled ? "text-violet-500" : "text-slate-400"}`}>
                            {config.description}
                          </p>
                        </div>
                      </button>
