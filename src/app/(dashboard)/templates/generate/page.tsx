        ...
        <div className="space-y-6">
          ...
          <div className="flex justify-end">
            <button
              ...
              className="px-6 py-2.5 bg-violet-600 text-white font-medium rounded-lg hover:bg-violet-700 transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
            >
              Continue
            </button>
          </div>
        ...
        <div className="space-y-6">
          ...
          <div className="flex justify-between">
            ...
            <button
              ...
              disabled={!name.trim()}
              className="flex items-center gap-2 px-6 py-2.5 bg-violet-600 text-white font-medium rounded-lg hover:bg-violet-700 transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
            >
            ...
            <div className="px-6 py-4 border-b border-slate-200 bg-slate-50">
              <div className="flex items-center justify-between">
                ...
                <Link
                  ...
                  className="flex items-center gap-2 px-4 py-2 text-sm font-medium text-violet-600 bg-violet-50 rounded-lg hover:bg-violet-100 transition-colors"
                >
