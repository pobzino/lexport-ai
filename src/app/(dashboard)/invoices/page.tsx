          ...
          <div className="flex flex-col md:flex-row gap-4">
            ...
            <div className="flex items-center gap-2">
              ...
              <select
                ...
                className="px-3 py-2 border border-slate-200 rounded-lg focus:outline-none focus:ring-2 focus:ring-violet-500 bg-white"
              >
                          ...
                          <td className="py-3 px-4">
                            {invoice.contract_id ? (
                              <Link
                                ...
                                className="text-sm text-violet-600 hover:underline truncate max-w-[150px] block"
                              >
                            ...
                            <div className="flex items-center justify-end gap-2">
                              ...
                              {invoice.status === "draft" && (
                                <button
                                  ...
                                  className="flex items-center gap-1.5 px-3 py-1.5 bg-violet-600 text-white text-sm font-medium rounded-lg hover:bg-violet-700 transition-colors disabled:opacity-50"
                                >
